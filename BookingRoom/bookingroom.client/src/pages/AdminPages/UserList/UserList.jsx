                ...
                <tbody>
                    {users.map((user) => (
                        ...
                        >
                            ...
                            <td className={styles.tableCell}>{user.fullName || 'N/A'}</td>
                            <td className={styles.tableCell}>{user.phoneNumber || 'N/A'}</td>
                            <td className={styles.tableCell}>{user.role || 'N/A'}</td>
                            <td className={styles.tableCell}>{user.points ?? 0}</td>
